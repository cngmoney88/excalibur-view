...
impl Tool {
    ...
    pub fn hint(self) -> &'static str {
        match self {
            ...
            Tool::Area => "Click around the shape. Double click, Enter or right click closes it.",
            ...
            Tool::AreaCutout => "Click round something to take it out of the area it sits in.",
            ...
            Tool::Perimeter => "Click round the shape. The measurement is the way round it, not the area inside.",
            ...
            Tool::Volume => "Click round the shape, then type the depth. Without a depth there is no volume.",
            Tool::Polyline => "Click each corner. Double click, Enter or right click finishes.",
            Tool::Polygon => "Click each corner. Double click, Enter or right click closes it.",
